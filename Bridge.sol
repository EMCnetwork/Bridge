...
contract Bridge is Pausable, AccessControl {
     ...
     */
    constructor (uint8 chainID, address[] memory initialRelayers, uint256 initialRelayerThreshold, uint256 fee, uint256 expiry,address wethAddress) public {
        require(wethAddress != address(0), "Invalid address: zero address");
        _chainID = chainID;
